    ...
    if (/Windows/.test(os)) {
      ...
      if (osVersion == 10 && navigator.userAgentData) {
        navigator.userAgentData
          ...
          .then(
            (ua) =>
              (window.jscd.osVersion =
                parseInt(ua.platformVersion.split('.')[0]) < 13 ? 10 : 11)
          );
      }
      os = 'Windows';
    }
...
// When we want to detect Windows 11, we must wait for the async call of userAgentData.getHighEntropyValues
